...
public class IZGroundFloor : NSObject {
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1343, height: 1308), resizing: ResizingBehavior = .aspectFit) {
        ...
        let stairs6Path = UIBezierPath()
        stairs6Path.move(to: CGPoint(x: 9, y: 27))
        stairs6Path.addLine(to: CGPoint(x: 9, y: 18))
        stairs6Path.addLine(to: CGPoint(x: 18, y: 18))
        stairs6Path.addLine(to: CGPoint(x: 18, y: 9))
        stairs6Path.addLine(to: CGPoint(x: 27, y: 9))
        stairs6Path.addLine(to: CGPoint(x: 27, y: 0))
        stairs6Path.addLine(to: CGPoint(x: 37, y: 0))
        stairs6Path.addLine(to: CGPoint(x: 37, y: 37))
        stairs6Path.addLine(to: CGPoint(x: 0, y: 37))
        stairs6Path.addLine(to: CGPoint(x: 0, y: 27))
        stairs6Path.addLine(to: CGPoint(x: 9, y: 27))
        stairs6Path.close()
        color.setFill()
        stairs6Path.fill()
        UIColor.darkGray.setStroke()
        stairs6Path.lineWidth = 1
        stairs6Path.lineCapStyle = .round
        stairs6Path.lineJoinStyle = .round
        stairs6Path.stroke()
