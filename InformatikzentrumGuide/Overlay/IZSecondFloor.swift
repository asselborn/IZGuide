...
public class IZSecondFloor : NSObject {
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1343, height: 1308), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Rectangle Drawing
        context.saveGState()
        context.translateBy(x: 441.18, y: 724.79)
        context.rotate(by: -17.55 * CGFloat.pi/180)

        let rectanglePath = UIBezierPath(rect: CGRect(x: -11.6, y: -1.2, width: 23.38, height: 3))
        background2.setFill()
        rectanglePath.fill()
        ...
        bezier88Path.move(to: CGPoint(x: 19.5, y: 0))
        bezier88Path.addLine(to: CGPoint(x: 19.5, y: 25))
        background2.setFill()
        bezier88Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier120Path.move(to: CGPoint(x: 19.5, y: 0))
        bezier120Path.addLine(to: CGPoint(x: 19.5, y: 25))
        background2.setFill()
        bezier120Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier131Path.move(to: CGPoint(x: 0, y: 4.5))
        bezier131Path.addLine(to: CGPoint(x: 38, y: 4.5))
        UIColor.lightGray.setFill()
        bezier131Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier184Path.move(to: CGPoint(x: 19.5, y: 0))
        bezier184Path.addLine(to: CGPoint(x: 19.5, y: 25))
        background2.setFill()
        bezier184Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier185Path.move(to: CGPoint(x: 0, y: 4.5))
        bezier185Path.addLine(to: CGPoint(x: 38, y: 4.5))
        UIColor.lightGray.setFill()
        bezier185Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier186Path.move(to: CGPoint(x: 0, y: 8.5))
        bezier186Path.addLine(to: CGPoint(x: 38, y: 8.5))
        UIColor.lightGray.setFill()
        bezier186Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier187Path.move(to: CGPoint(x: 0, y: 12.5))
        bezier187Path.addLine(to: CGPoint(x: 38, y: 12.5))
        UIColor.lightGray.setFill()
        bezier187Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier188Path.move(to: CGPoint(x: 0, y: 16.5))
        bezier188Path.addLine(to: CGPoint(x: 38, y: 16.5))
        UIColor.lightGray.setFill()
        bezier188Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier189Path.move(to: CGPoint(x: 0, y: 20.5))
        bezier189Path.addLine(to: CGPoint(x: 38, y: 20.5))
        UIColor.lightGray.setFill()
        bezier189Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier190Path.move(to: CGPoint(x: 0, y: 24.5))
        bezier190Path.addLine(to: CGPoint(x: 38, y: 24.5))
        UIColor.lightGray.setFill()
        bezier190Path.fill()
        UIColor.darkGray.setStroke()
