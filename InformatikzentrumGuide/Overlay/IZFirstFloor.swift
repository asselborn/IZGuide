...
public class IZFirstFloor : NSObject {
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1343, height: 1308), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Rectangle 2 Drawing
        context.saveGState()
        context.translateBy(x: 324.18, y: 374.73)
        context.rotate(by: -17.55 * CGFloat.pi/180)

        let rectangle2Path = UIBezierPath(rect: CGRect(x: -12.27, y: -1.2, width: 24.65, height: 3))
        background2.setFill()
        rectangle2Path.fill()
        ...
        //// Rectangle Drawing
        context.saveGState()
        context.translateBy(x: 440.35, y: 724.67)
        context.rotate(by: -17.55 * CGFloat.pi/180)

        let rectanglePath = UIBezierPath(rect: CGRect(x: -12.4, y: -1.2, width: 25, height: 3))
        background2.setFill()
        rectanglePath.fill()
        ...
        bezier186Path.move(to: CGPoint(x: 19.5, y: 0))
        bezier186Path.addLine(to: CGPoint(x: 19.5, y: 25))
        background2.setFill()
        bezier186Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier187Path.addLine(to: CGPoint(x: 38, y: 4.5))
        UIColor.lightGray.setFill()
        bezier187Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier188Path.addLine(to: CGPoint(x: 38, y: 8.5))
        UIColor.lightGray.setFill()
        bezier188Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier189Path.addLine(to: CGPoint(x: 38, y: 12.5))
        UIColor.lightGray.setFill()
        bezier189Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier190Path.addLine(to: CGPoint(x: 38, y: 16.5))
        UIColor.lightGray.setFill()
        bezier190Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier191Path.addLine(to: CGPoint(x: 38, y: 20.5))
        UIColor.lightGray.setFill()
        bezier191Path.fill()
        UIColor.darkGray.setStroke()
        ...
        bezier192Path.addLine(to: CGPoint(x: 38, y: 24.5))
        UIColor.lightGray.setFill()
        bezier192Path.fill()
        UIColor.darkGray.setStroke()
